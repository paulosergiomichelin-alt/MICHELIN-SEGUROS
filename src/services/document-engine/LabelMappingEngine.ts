...
export class LabelMappingEngine {
  private static LABELS = {
    name: ['NOME', 'NOME DO SEGURADO', 'SEGURADO', 'CONDUTOR', 'NOME COMPLETO'],
    cpf: ['CPF', 'CPF/CNPJ', 'DOCUMENTO', 'CIC'],
    ...
    validity: ['VALIDADE', 'DATA VALIDADE', 'VIGENCIA', 'VENCIMENTO'],
    dob: ['DATA NASCIMENTO', 'NASCIMENTO', 'DT NASC', 'NASC'],
    renach: ['RENACH', 'N RENACH'],
    licenseExpiry: ['VALIDADE', 'VENCIMENTO CNH'],
    issueDate: ['DATA EMISSAO', 'EMISSAO', 'EXPEDICAO'],
    brandModel: ['MARCA/MODELO', 'MARCA', 'MODELO', 'VEICULO'],
    brokerName: ['CORRETORA', 'CORRETOR', 'DADOS DO CORRETOR', 'PRODUTOR', 'CONSULTOR', 'ASSESSORIA', 'CANAL DE VENDA', 'INTERMEDIADOR', 'REPRESENTANTE', 'PARCEIRO', 'ESCRITÓRIO'],
