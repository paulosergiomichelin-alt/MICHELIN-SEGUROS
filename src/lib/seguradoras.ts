...
// Os logos eram carregados via logo.clearbit.com (hotlink de terceiro), mas esse domínio
// costuma ser bloqueado por DNS/bloqueadores de anúncio no navegador do usuário, gerando
// ERR_NAME_NOT_RESOLVED em massa no console. Usamos só o avatar colorido com a inicial.
